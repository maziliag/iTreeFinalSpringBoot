package com.finaltest.NaujokuManageris;
...
public class NaujokuManagerisApplication {
	
	
	
	public static void main(String[] args) {
		SpringApplication.run(NaujokuManagerisApplication.class, args);
